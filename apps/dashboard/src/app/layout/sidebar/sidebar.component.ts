...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Economy', path: 'economy', icon: 'economy' },
    { label: 'Users', path: 'users', icon: 'users' },
    { label: 'Music', path: 'music', icon: 'music' },
    { label: 'Moderation', path: 'moderation', icon: 'moderation' },
    { label: 'AutoRoles', path: 'autoroles', icon: 'autoroles' },
    { label: 'Config', path: 'config', icon: 'config' },
